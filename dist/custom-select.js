...
var defaultConfig = __webpack_require__(/*! ./default-config */ "./src/default-config.js"); // Private members
...
var _updateOriginalSelectValue = Symbol();

var _updateCopySelectValue = Symbol();
...
function () {
  ...
  _createClass(CustomSelect, [{
    ...
    value: function value(customElement) {
      ...
      csContainer.classList.add('cs-container'); // Create container for original select
      ...
      var csBackdrop = this[_createBackdrop]();

      _csBackdrop.set(this, csBackdrop); // Inserting containers into main container
      ...
      csContainer.append(csBackdrop); // Create private member for csContainer;
    ...
    value: function value(select) {
      ...
      select.options.length && [].forEach.call(select.options, function (option) {
        ...
        copied.value = option.value; // Assign selected attribute into relevant option

        copied.selected = option.selected; // copy data attrs
    ...
    value: function value(option) {
      ...
      singleOption.dataset.optionId = option.value; // update all structure of the custom select

      !_csIsMultiple.get(this) && singleOption.addEventListener('click', function (event) {
        ...
        _this2[_updateOriginalSelectValue](option.value);

        _this2[_updateCopySelectValue](option.value);

        _this2[_updatePlaceholder](_config.get(_this2).mapTplToPlaceholder.call(_this2, singleOption));
    ...
    value: function value() {
      ...
      _csPlaceholderContainer.set(this, csPlaceholder); // update placeholder
    ...
    key: _updateOriginalSelectValue,
    value: function value(_value) {
      _customSelect.get(this).value = _value;
    }
  }, {
    key: _updateCopySelectValue,
    value: function value(_value2) {
      _customSelectCopy.get(this).value = _value2;
    } // Update placeholder

  }, {
    key: _updatePlaceholder,
    value: function value(_value3) {
      _csPlaceholderContainer.get(this).innerText = _value3;
    ...
    value: function value() {
      ...
      var cs = _customSelectCopy.get(this);

      cs.options.length && [].forEach.call(cs.options, function (opt) {
        return opt.selected && _this4[_updatePlaceholder](opt.innerText);
      });
    ...
    value: function value() {
      ...
      options.length && options.forEach(function (opt) {
        return opt.dataset.optionId === _customSelectCopy.get(_this5).value ? opt.classList.add('active') : opt.classList.remove('active');
      });
    }
  }, {
    key: _createBackdrop,
